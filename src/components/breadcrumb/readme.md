...
```js
import { Breadcrumb } from 'winduum-vue/src/components/breadcrumb'
```

### Docs
Visit [docs](https://winduum.dev/docs/components/breadcrumb.html) to learn more and see usage examples.
