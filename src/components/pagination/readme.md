...
```js
import { Pagination } from 'winduum-vue/src/components/pagination'
```

### Docs
Visit [docs](https://winduum.dev/docs/components/pagination.html) to learn more and see usage examples.
