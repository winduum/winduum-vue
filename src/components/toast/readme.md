...
```js
import { Toast, ToastContent } from 'winduum-vue/src/components/toast'
```

### Docs
Visit [docs](https://winduum.dev/docs/components/toast.html) to learn more and see usage examples.
