...
```js
import { Carousel } from 'winduum-vue/src/components/carousel'
```

### Docs
Visit [docs](https://winduum.dev/docs/components/carousel.html) to learn more and see usage examples.
