...
```js
import { Dialog, DialogContent } from 'winduum-vue/src/components/dialog'
```

### Docs
Visit [docs](https://winduum.dev/docs/components/dialog.html) to learn more and see usage examples.
